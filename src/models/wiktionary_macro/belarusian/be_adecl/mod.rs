...
pub mod class_selectors {
    pub const ALL: [&str; 30] = [LOC_M,LOC_F,LOC_N,LOC_P,INS_M,INS_F,INS_N,INS_P,AN_ACC_M,INAN_ACC_M,ACC_F,ACC_N,IN_ACC_P,INAN_ACC_P,DAT_M,DAT_F,DAT_N,DAT_P,GEN_M,GEN_F,GEN_N,GEN_P,NOM_M,NOM_F,NOM_N,NOM_P,SHORT_M,SHORT_F,SHORT_N,SHORT_P,];
    //
